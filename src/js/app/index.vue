<template>
  <div :class="[$store.state.appPrefix + '-my-app']">
    ...
    <el-dialog
      ...
      :success-cb="loginSuccessCb"></user-login>
    </el-dialog>
  </div>
</template>
...
<script>
  ...
  import { NAVIGATOR_LIST, NEED_SHOW_LOGIN_POP } from 'store/mutation-types'
  import { getNavigatorList, runEventQueue } from './models'
